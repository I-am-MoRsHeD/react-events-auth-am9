    ...
    return (
        <div>
            <footer className="footer footer-center py-20 px-10 bg-base-200 text-base-content rounded">
                <Marquee speed={100}>
                    <div>
                        <h1 className="text-4xl font-extrabold">Thank you for staying with us <br /> And <br />make our days joyful!</h1>
                    </div>
                </Marquee>
                <div>
                    <h2 className='text-2xl font-semibold'>Our Event Partners</h2>
